...
namespace FWPet.Dao
{
    internal class DaoResponsavel
    {
        internal static void Salvar(Responsavel item)
        {
        ...
        internal static List<Responsavel> Pesquisar()
        {
            ...
            sSql.AppendLine("AND pessoa.tipo='R';");
            ...
            try
            {
                ...
                if (scom.HasRows)
                {
                    Lst = new List<Responsavel>();
                    Responsavel item = null;
                    while (scom.Read())
                    {
                        item = new Responsavel()
                        {
        ...
        internal static void Excluir(Responsavel item)
        {
            StringBuilder sSql = new StringBuilder();
        ...
        internal static Responsavel Obter(long _Responsavel)
        {
            StringBuilder sSql = new StringBuilder();
            sSql.AppendLine("SELECT");
            sSql.AppendLine("     pessoa.id");
        ...
        private static void Inserir(Responsavel item)
        {
            StringBuilder sSql = new StringBuilder();
            sSql.AppendLine("INSERT INTO pessoa (nome, rg, cpf, data_nascimento, tipo, sexo, email, celular, telefone, outro_contato)");
            sSql.AppendLine("VALUES (@nome, @rg, @cpf, @data_nascimento, 'R', @sexo, @email, @celular, @telefone, @outro_contato);SELECT LAST_INSERT_ID();");
        ...
        private static void Alterar(Responsavel item)
        {
            StringBuilder sSql = new StringBuilder();
            sSql.AppendLine("UPDATE pessoa SET ");
