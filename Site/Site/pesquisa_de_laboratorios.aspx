<%@ Page Title="" Language="C#" MasterPageFile="~/_MLogado.master" AutoEventWireup="true" CodeBehind="pesquisa_de_laboratorios.aspx.cs" Inherits="Site.pesquisa_de_laboratorios" %>
		...
		<div class="tbl">
			<div class="tbl-row">
				<div class="col-md-10 col-sm-8 col-xs-12 tbl-cell">
					<h2>Laboratórios</h2>
					<div class="subtitle">Lista com os laboratórios cadastrados.</div>
