<%@ Page Title="" Language="C#" MasterPageFile="~/_MLogado.master" AutoEventWireup="true" CodeBehind="cadastro_de_laboratorio.aspx.cs" Inherits="Site.cadastro_de_laboratorio" %>
...
<%--    <asp:ScriptManager runat="server" ID="srcM"></asp:ScriptManager>--%>
    ...
    <asp:Panel runat="server" ID="pnl01" DefaultButton="lnkSalvar">
        <div class="box-typical box-typical-padding">
            <h5 class="m-t-lg with-border">Cadastro de Laboratórios</h5>
            <div class="row">
                ...
                <div class="col-md-5 col-sm-12 col-xs-12">
                    <label class="form-control-label">Razao Social</label>
