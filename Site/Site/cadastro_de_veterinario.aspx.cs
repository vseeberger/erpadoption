...
namespace Site
{
    public partial class cadastro_de_veterinario : _Herdar
    {
        private static Veterinario _Origem;
        ...
        protected override void OnLoadComplete(EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                {
                    Veterinario itm = Veterinario.Obter(i);
                    _Veterinario = itm;
                    _Origem = itm;
                }
                else
        ...
        protected void lnkSalvar_Click(object sender, EventArgs e)
        {
            try
            {
                Veterinario o = _Veterinario;
                o.Salvar();

                long l;
                long.TryParse(txtCodigo.Text, out l);
                GravarLog(l == 0 ? 1 : 2, " O VETERINARIO CÓDIGO: " + o.Id, Util.serializarObjetos(_Origem, _Origem.GetType()), Util.serializarObjetos(o, o.GetType()), o.GetType());

                MensagemAlertaPopup("Os dados foram gravados com sucesso.<br/>Código: " + o.Id.ToString("0000"), Mensagens.Pergunta, this, "/TodosOsVeterinarios", "/CadastroDeVeterinario");
            }
        ...
        {
            Response.Redirect("~/TodosOsVeterinarios");
        }
