<%@ Page Title="" Language="C#" MasterPageFile="~/_MLogado.master" AutoEventWireup="true" CodeBehind="cadastro_de_veterinario.aspx.cs" Inherits="Site.cadastro_de_veterinario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cConteudo" runat="server">
    <asp:Panel runat="server" ID="pnl01" DefaultButton="lnkSalvar">
        <div class="box-typical box-typical-padding">
            <h5 class="m-t-lg with-border">Cadastro de Veterinário</h5>
            <div class="row">
                ...
                <div class="col-md-2 col-sm-6 col-xs-12">
                    <label class="form-control-label" title="Conselho Regional de Medicina Veterinária">CRMV</label>
                    <asp:TextBox runat="server" ID="txtCodCRMV" CssClass="form-control"></asp:TextBox>
                </div>
                <div class="col-md-2 col-sm-6 col-xs-12">
