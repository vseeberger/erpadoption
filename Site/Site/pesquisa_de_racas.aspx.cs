...
namespace Site
{
    public partial class pesquisa_de_racas : _Herdar
    {
        ...
        protected void rptResultado_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            try
            {
                ...
                {
                    case "Alterar":
                        Response.Redirect("~/CadastroDeRaca?" + e.CommandArgument);
                        break;
                    case "Remover":
                        ...
                        o.Excluir();
                        Type tipo = o.GetType();
                        GravarLog(3, " A RAÇA CODIGO " + o.Id, null, Util.serializarObjetos(o, tipo), tipo);
                        CarregarLista();
                        break;
                }
            }
        ...
        {
            Response.Redirect("~/CadastroDeRaca");
        }
    }
}