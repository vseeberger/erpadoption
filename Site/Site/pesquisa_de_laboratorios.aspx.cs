...
namespace Site
{
    public partial class pesquisa_de_laboratorios : _Herdar
    {
        ...
        {
            List<Laboratorio> Lst = Laboratorio.Pesquisar();
        ...
        protected void rptResultado_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            try
            {
                ...
                {
                    case "Alterar":
                        Response.Redirect("~/CadastroDeLaboratorio?" + e.CommandArgument);
                        break;
                    case "Remover":
                        ...
                        o.Excluir();
                        Type tipo = o.GetType();
                        GravarLog(3, " O LABORATORIO CODIGO " + o.Id, null, Util.serializarObjetos(o, tipo), tipo);
                        CarregarLista();
                        break;
                }
            }
        ...
        {
            Response.Redirect("~/CadastroDeLaboratorio");
        }
    }
}