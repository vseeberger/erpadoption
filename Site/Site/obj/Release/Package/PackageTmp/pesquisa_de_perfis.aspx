<%@ Page Title="" Language="C#" MasterPageFile="~/_MLogado.master" AutoEventWireup="true" CodeBehind="pesquisa_de_perfis.aspx.cs" Inherits="Site.pesquisa_de_perfis" %>
		...
		<div class="tbl">
			<div class="tbl-row">
				<div class="col-md-10 col-sm-8 col-xs-12 tbl-cell">
					...
					<div class="subtitle">Lista perfis já cadastrados.</div>
                ...
                <asp:Repeater runat="server" ID="rptResultado" OnItemCommand="rptResultado_ItemCommand">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><asp:LinkButton runat="server" CommandArgument='<%#Eval("Id") %>' OnClientClick="return fnConfirmar();" CommandName="Remover" ID="lnkRemover" CssClass="btn"><i class="glyphicon glyphicon-remove"></i></asp:LinkButton></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
