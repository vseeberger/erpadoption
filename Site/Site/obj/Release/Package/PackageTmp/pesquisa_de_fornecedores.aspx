<%@ Page Title="" Language="C#" MasterPageFile="~/_MLogado.master" AutoEventWireup="true" CodeBehind="pesquisa_de_fornecedores.aspx.cs" Inherits="Site.pesquisa_de_fornecedores" %>
		...
		<div class="tbl">
			<div class="tbl-row">
				<div class="col-md-10 col-sm-8 col-xs-12 tbl-cell">
					<h2>Fornecedores</h2>
					<div class="subtitle">Lista com os fornecedores cadastrados.</div>
		...
		<div class="card-block">
            <table class="tabelasdinamicas display table table-striped table-bordered table-responsive" width="100%">
                <thead>
				    <tr>
					    <th>#</th>
					    <th width="100%">Razão Social/Nome</th>
                        <th>CNPJ/CPF</th>
					    <th>Cadastro</th>
                        <th> </th>
                        <th> </th>
