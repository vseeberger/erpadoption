<%@ Page Title="" Language="C#" MasterPageFile="~/_MLogado.master" AutoEventWireup="true" CodeBehind="pesquisa_de_formularios.aspx.cs" Inherits="Site.pesquisa_de_formularios" %>
		...
		<div class="tbl">
			<div class="tbl-row">
				<div class="col-md-10 col-sm-8 col-xs-12 tbl-cell">
					<h2>Formulários de permissão</h2>
					<div class="subtitle">Lista de formulários já cadastrados.</div>
                ...
                <asp:Repeater runat="server" ID="rptResultado" OnItemCommand="rptResultado_ItemCommand">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%#Eval("SNome") %></td>
                            <td align="center"><%#Eval("IAgrupador") %></td>
                            <td><%#Eval("EhMenu") %></td>
