<%@ Page Title="" Language="C#" MasterPageFile="~/_MLogado.master" AutoEventWireup="true" CodeBehind="cadastro_de_clinica.aspx.cs" Inherits="Site.cadastro_de_clinica" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cConteudo" runat="server">
    ...
    <asp:Panel runat="server" ID="pnl01" DefaultButton="lnkSalvar">
        <div class="box-typical box-typical-padding">
            <h5 class="m-t-lg with-border">Cadastro de Clínica / Laboratorio</h5>
            <div class="row">
