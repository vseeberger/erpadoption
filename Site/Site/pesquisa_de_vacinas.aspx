<%@ Page Title="" Language="C#" MasterPageFile="~/_MLogado.master" AutoEventWireup="true" CodeBehind="pesquisa_de_vacinas.aspx.cs" Inherits="Site.pesquisa_de_vacinas" %>
		...
		<div class="tbl">
			<div class="tbl-row">
				<div class="col-md-10 col-sm-8 col-xs-12 tbl-cell">
					<h2>Vacinas</h2>
					<div class="subtitle">Lista as vacinas ativas cadastradas no sistema</div>
                ...
                <asp:Repeater runat="server" ID="rptResultado" OnItemCommand="rptResultado_ItemCommand">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%#Eval("SNome") %></td>
                            <td><%#Eval("Especie.SDescricao") %></td>
                            <td><%#Convert.ToInt32(Eval("IQuantidadeDoses")).ToString("00") %></td>
                            ...
                            <td><asp:LinkButton runat="server" CommandArgument='<%#Eval("Id") %>' CommandName="Remover" ID="lnkRemover" CssClass="btn"><i class="glyphicon glyphicon-remove"></i></asp:LinkButton></td>
                        </tr>
                    </ItemTemplate>
                </asp:Repeater>
