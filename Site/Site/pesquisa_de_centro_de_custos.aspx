<%@ Page Title="" Language="C#" MasterPageFile="~/_MLogado.master" AutoEventWireup="true" CodeBehind="pesquisa_de_centro_de_custos.aspx.cs" Inherits="Site.pesquisa_de_centro_de_custos" %>
		...
		<div class="tbl">
			<div class="tbl-row">
				<div class="col-md-10 col-sm-8 col-xs-12 tbl-cell">
					...
					<div class="subtitle">Lista os centro de custos já cadastrados.</div>
