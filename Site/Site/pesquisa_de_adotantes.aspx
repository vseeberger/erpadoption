<%@ Page Title="" Language="C#" MasterPageFile="~/_MLogado.master" AutoEventWireup="true" CodeBehind="pesquisa_de_adotantes.aspx.cs" Inherits="Site.pesquisa_de_adotantes" %>
		...
		<div class="tbl">
			<div class="tbl-row">
				<div class="col-md-10 col-sm-8 col-xs-12 tbl-cell">
					<h2>Adotantes</h2>
					<div class="subtitle">Lista com os adotantes cadastrados.</div>
				</div>
            ...
            <table class="tabelasdinamicas display table table-striped table-bordered table-responsive" width="100%">
                <thead>
				    <tr>
                        ...
                        <th nowrap="nowrap">Qtd. Adoções</th>
					    <th>Cadastro</th>
                        <th> </th>
                        <th> </th>
				    </tr>
                ...
                <asp:Repeater runat="server" ID="rptResultado" OnItemCommand="rptResultado_ItemCommand">
                    <ItemTemplate>
                        <tr>
                            ...
                            <td><%#Eval("SNome") %></td>
                            <td align="center"><%#Eval("IQtdAnimais") %></td>
