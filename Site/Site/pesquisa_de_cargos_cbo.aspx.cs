...
namespace Site
{
    public partial class pesquisa_de_cargos_cbo : _Herdar
    {
        ...
        protected void rptResultado_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            try
            {
                ...
                {
                    case "Alterar":
                        Response.Redirect("~/CadastroDeCBO?" + e.CommandArgument);
                        break;
                    case "Remover":
                        ...
                        CBO _item = new CBO(i);
                        _item.Excluir();
                        GravarLog(3, " O CBO, CÓDIGO" + i, null, Util.serializarObjetos(_item, _item.GetType()), _item.GetType());
                        CarregarLista();
                        break;
                }
            }
        ...
        {
            Response.Redirect("~/CadastroDeCBO");
        }
    }
}